...
export const Header_administrator = () => {
    ...
    return (
        <header className="flex justify-between items-center bg-white p-4 px-20 shadow-md relative">
            ...
            <nav className="peer-checked:flex hidden absolute z-20 top-full left-0 w-full bg-white flex-col items-center space-y-4 shadow-lg md:relative md:top-0 md:flex md:flex-row md:w-auto md:space-x-4 md:bg-transparent md:shadow-none">
                <NavLink to="/Approve_reports" className={({ isActive }) => isActive ? "text-primary font-bold" : "text-black"}>
                    Aprobacion de proyectos externos
                </NavLink>

                <NavLink to="/ReportInternalFailures1" className={({ isActive }) => isActive ? "text-primary font-bold" : "text-black"}>
                    Aprobacion de proyectos internos
                </NavLink>
            ...
            <div className="hidden md:flex space-x-2">
                {isLoggedIn ? (
                    ...
                    <>
                        <NavLink to="/Registration_administrator" className="bg-primary text-white px-4 py-2 rounded">
                            Registrarse
                        </NavLink>
                        <NavLink to="/Login_administrator" className="border border-primary text-primary px-4 py-2 rounded">
                            Iniciar sesión
                        </NavLink>
                    </>
                )}
...
export default Header_administrator;
